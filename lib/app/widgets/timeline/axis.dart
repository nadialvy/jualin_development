...
class AxisPosition {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is AxisPosition && runtimeType == other.runtimeType && firstSpace == other.firstSpace && objectSpace == other.objectSpace && secondSpace == other.secondSpace;

  @override
  int get hashCode => firstSpace.hashCode ^ objectSpace.hashCode ^ secondSpace.hashCode;
...
class AxisCoordinates {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AxisCoordinates && runtimeType == other.runtimeType && start == other.start && end == other.end && size == other.size;
...
AxisPosition calculateAxisPositioning({
  ...
  if (axisPosition < 0.0 || axisPosition > 1.0) {
    throw AssertionError(
      'The axisPosition must be provided and must be a value'
...
AxisPosition _alignObject({
  ...
  return AxisPosition(
    firstSpace: alignStart ? AxisCoordinates.zero() : AxisCoordinates(start: 0, end: totalSize - objectSize),
    objectSpace: alignStart ? AxisCoordinates(start: 0, end: objectSize) : AxisCoordinates(start: totalSize - objectSize, end: totalSize),
    secondSpace: alignEnd ? AxisCoordinates(start: totalSize, end: totalSize) : AxisCoordinates(start: objectSize, end: totalSize),
  );
}
