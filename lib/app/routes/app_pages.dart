...
import '../modules/buyer-interface/dashboard_buyer/list_all_stall_buyer/list_all_stall_buyer_binding.dart';
import '../modules/buyer-interface/dashboard_buyer/list_all_stall_buyer/list_all_stall_buyer_view.dart';
  ...
  static final routes = [
    ...
    GetPage(
      ...
      children: [
        ...
        GetPage(
          name: _Paths.LIST_ALL_STALL_BUYER,
          page: () => ListAllStallBuyerView(),
          binding: ListAllStallBuyerBinding(),
        ),
      ],
    ),
    GetPage(
