...
class PersistentTabBuyerView extends GetView<PersistentTabBuyerController> {
  const PersistentTabBuyerView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetBuilder<PersistentTabBuyerController>(
        init: PersistentTabBuyerController(),
        initState: (_) {},
