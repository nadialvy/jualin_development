...
import 'package:jualin_flutter_3/app/modules/buyer-interface/cadger_list/cadger_list_controller.dart';
...
class CadgerListView extends GetView<CadgerListController> {
  const CadgerListView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: 'List Pedagang Kaki Lima'.text.bold.color(colorBlack).make(),
          leading: const Icon(
            Icons.arrow_back,
            color: colorBlack,
          ).onTap(() => Get.back()),
